...
function buildPayload() {
  return {
    ...
    switchboard: {
      ...
      water_ingress: ans("no"),
      asbestos_suspected: ans("no"),
      protection_types_present: ans(["rcd", "rcbo"]),
      board_at_capacity: ans(false),
      spare_ways_available: ans("yes"),
      labelling_quality: ans("good"),
    ...
    gpo_tests: {
      performed: ans(true),
      summary: {
        total_gpo_tested: ans(12),
        polarity_pass: ans(12),
        earth_present_pass: ans(11),
        rcd_protection_confirmed: ans(12),
      },
      any_warm_loose_damaged: ans(false),
      rooms: ans([
        {
          room_type: "kitchen",
          room_name_custom: "",
          room_access: "accessible",
          gpo_count: 4,
          tested_count: 4,
          pass_count: 3,
          issue: "loose",
